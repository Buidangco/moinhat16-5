                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="ecommerce-widget">
                       ...
                       @foreach($data1 as $row1)
                           <input type="text" value="{{$row1->Ten}}" style="opacity: 0;" name="tenncc">
                        @endforeach
                          ...
                          <input onclick="ThemAd('{{$da->id}}','{{$da->masery}}','{{$da->Mancc}}','{{$da->name}}','{{$da->price}}','{{$row1->Ten}}')" type="submit" value="Thêm" style="color: white;background-color:#24315f;">
                        </div>
                          @endforeach
                        <div class="row">
       ...
       <script>
             function ThemAd(id,sery,mancc,tensp,gia,tenncc) {
